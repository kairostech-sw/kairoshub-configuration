!(function (t, e) {
  ...
  class ce extends yt {
    constructor(t) {
      super(),
        (this.shadowRoot.innerHTML =
          "<style>.expander-card{display:grid;gap:var(--gap);padding:var(--padding);transition:all 0.3s ease-in-out}.children-container{padding:var(--child-padding);display:grid;gap:var(--gap);transition:all 0.3s ease-in-out}.clear{background-color:transparent;border-style:none}.title-card-header{display:flex;align-items:center;justify-content:space-between;flex-direction:row}.title-card-header-overlay{display:block}.title-card-container{width:100%;padding:var(--title-padding)}.header{display:flex;flex-direction:row;align-items:center;padding:0.8em 0.8em;margin:2px;background:var(--button-background);border-style:none}.header-overlay{position:absolute;top:0;right:0;margin:var(--overlay-margin)}.title{width:100%;text-align:left}.ico{color:#000000;transition-property:transform;transition-duration:0.35s}.flipped{transform:rotate(180deg)}.ripple{background-position:center;transition:background 0.8s;border-radius:1em}.ripple:hover{background:#ffffff12 radial-gradient(circle, transparent 1%, #ffffff12 1%) center/15000%}.ripple:active{background-color:#ffffff25;background-size:100%;transition:background 0s}</style>"),
        vt(
          this,
          {
            target: this.shadowRoot,
