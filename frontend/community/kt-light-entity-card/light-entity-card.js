  ...
  function (t, e, n) {
    ...
    var r = n(1),
      ...
      X = function (t) {
        ...
        return (
          !(this === D && i(U, t) && !i(W, t)) &&
          (!(e || !i(this, t) || !i(U, t) || (i(this, $) && this[$][t])) || e)
        );
      },
      Z = function (t, e) {
        if (((t = w(t)), (e = x(e, !0)), t !== D || !i(U, e) || i(W, e))) {
          var n = j(t, e);
          return (
            !n || !i(U, e) || (i(t, $) && t[$][e]) || (n.enumerable = !0), n
          );
        }
      },
      Q = function (t) {
        for (var e, n = T(w(t)), r = [], o = 0; n.length > o; )
          i(U, (e = n[o++])) || e == $ || e == u || r.push(e);
        return r;
      },
      tt = function (t) {
        for (
        ...
        for (
          ...
          if (null !== d) {
            if ((c++, 1 === d.nodeType)) {
              ...
              if (P.indexOf(s) >= 0) {
                for (
                  var O = d.parentNode, C = P.split(l), A = C.length - 1, j = 0;
                  j < A;
                  j++
                ) {
                  var N = void 0,
      ...
      (It.render = function (t, e, n) {
        ...
        if (
          ((function (t, e, n) {
            ...
            void 0 === r &&
              (a(e, e.firstChild),
              Y.set(e, (r = new R(Object.assign({ templateFactory: H }, n)))),
              r.appendInto(e)),
              r.setValue(t),
              r.commit();
...
`;
  ...
  `;
      ...
      _setValue(t, e, n) {
        ...
        isNaN(r) ||
          parseInt(e.attributes[n], 0) === r ||
          this.callEntityService({ [n]: r }, e);
      }
      setToggle(t, e) {
      ...
      setAttributes(payload, stateObj, state) {
        const { access_token, hassUrl } = this.hass.auth.data;

        var attributes = this.parseAttributes(payload, stateObj);
        state = state ? state.replace("turn_", "") : stateObj.state;

        fetch(hassUrl + "/api/states/" + stateObj.entity_id, {
          method: "POST",
          body: JSON.stringify({
            state,
            attributes,
      ...
      parseAttributes(payload, state) {
        const { hs_color, brightness, white_value } = payload;
        const DEFAULT_ATTRIBUTES = {
          supported_color_modes: this.getColorMode(state.entity_id),
          brightness: state.attributes.brightness ?? 255,
          hs_color: state.attributes.hs_color ?? [0, 0],
          rgbw_color: state.attributes.rgbw_color ?? [255, 255, 255, 255],
          white_value: state.attributes.white_value ?? 255,
        };
        const attributes = { ...DEFAULT_ATTRIBUTES };

        if (hs_color !== undefined) {
          attributes.hs_color = hs_color;
          attributes.rgbw_color = this.HSBToRGB(
            attributes.rgbw_color[3],
            hs_color[0],
            hs_color[1]
          );
        }
        ...
        if (white_value !== undefined) {
          attributes.rgbw_color[3] = white_value;
      ...
      HSBToRGB(white, h, s, b = 100) {
        ...
        const f = (n) => {
          const t = b * (1 - s * Math.max(0, Math.min(k(n), 4 - k(n), 1)));
          return t;
        };
        return [
          Math.floor(255 * f(5)),
      ...
      getColorMode(entity) {
        ...
        if (entity.includes("lcz")) return ["hs", "rgbw"];
        if (entity.includes("lwz")) return ["brightness"];
        return ["onoff"];
      }
    }
